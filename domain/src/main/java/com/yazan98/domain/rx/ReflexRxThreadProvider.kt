package com.yazan98.domain.rx

import com.yazan98.exposer.usecases.base.ExposerThreadProvider
 ...
 */
interface ReflexRxThreadProvider : ExposerThreadProvider<Scheduler> {

    override fun getBackgroundThread(): Scheduler = Schedulers.io()
    override fun getMainThread(): Scheduler = getUserInterfaceProvider()
    override fun getNewThread(): Scheduler = Schedulers.newThread()
    fun getUserInterfaceProvider(): Scheduler
